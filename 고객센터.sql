...
INSERT INTO GROUP_BOARD (group_loc,group_type, group_expeople,group_date,group_time1,group_time2,group_movtitle,group_title,group_con,group_name,custo_name,custo_phone1,custo_phone2,custo_phone3)
VALUES ('','대관',5,'2024-03-22',2,3,'듄','예약하고싶어요','어떻게 예약해요?','노랑풍선','김주희','010','3189','5555');

select *from GROUP_BOARD;
-----------------------------------------------------------------------------------------

-- 답변테이블
DROP TABLE re_answer CASCADE;
CREATE TABLE re_answer(  
    group_num_aws  INT             NOT NULL,        -- 코드
    re_title       VARCHAR(50)     NOT NULL,         -- 제목
    re_con         LONGTEXT        NOT NULL,        -- 내용
    re_date        DATE            NOT NULL         -- 작성일
);

select * from re_answer;

...
import MyPage_consult_answer_part from './MyPage_consult_answer_part'
class MyPage_consult_answer extends Component{
    render(){
        return(
            <div>
...
export default MyPage_consult_answer;
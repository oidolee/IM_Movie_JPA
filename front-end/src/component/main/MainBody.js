...
const MainBody = () => {
  ...
  const handleTogglePlay = () => {
    setIsPlaying(prevState => !prevState); // isPlaying 상태를 토글
  };
  ...
  return (
    <div>
      ...
      <div className={`MainBody_contents ${style.MainBody_contents}`}>
        ...
        <div className={`scrollUp MainBody_contents_top MainBody_contents_top_3 ${style.MainBody_contents_top} ${style.MainBody_contents_top_3}`}>
          <span>이벤트</span>
          <ul style={{ height: '22px', overflowY: 'hidden' }}>
        ...
        <div className={`scrollUp MainBody_section_1 ${style.MainBody_section_1}`}>
          <div className={`MainBody_contents_left ${style.MainBody_contents_left}`}>
            ...
            <div className={`scrollUp MainBody_contents1_leftBottom ${style.MainBody_contents1_leftBottom}`}>
              <ul>
          ...
          <div className={`scrollUp MainBody_contents_right ${style.MainBody_contents_right}`}>
            <a href='#'>
        ...
        <div className={`scrollUp MainBody_section_2 ${style.MainBody_section_2}`}>
          <ul>
